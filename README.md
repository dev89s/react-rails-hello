...
# 📖 [Hello React Rails] <a id="about-project"></a>

**[Hello React Rails]** is a test app based on Ruby on Rails and setup With react configuration to learn the process
of installing these two frameworks together.
...
```
  git clone https://github.com/dev89/react-rails-hello.git
```
...
Feel free to check the [issues page](https://github.com/dev89s/react-rails-hello/issues).
